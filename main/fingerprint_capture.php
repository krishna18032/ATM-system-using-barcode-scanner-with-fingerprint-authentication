...
if(isset($_POST['submit']))
{
    ...
    $txtIsoTemplate = mysqli_real_escape_string($db, $_POST['txtIsoTemplate']);
...
$query = "insert into register(fingerprint) values('$txtIsoTemplate');";
mysqli_query($db, $query);

$query = "insert into login(activation) values ('$activation');";
mysqli_query($db, $query);
